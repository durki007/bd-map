...
public class BdPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Bd";
	...
	private BdPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(User.class);
		aMetadataSources.addAnnotatedClass(Changeset.class);
		aMetadataSources.addAnnotatedClass(HistoricWayData.class);
		aMetadataSources.addAnnotatedClass(HistoricWayNode.class);
		aMetadataSources.addAnnotatedClass(HistoricNodeData.class);
		aMetadataSources.addAnnotatedClass(Way.class);
		aMetadataSources.addAnnotatedClass(WayNode.class);
		aMetadataSources.addAnnotatedClass(Node.class);
		aMetadataSources.addAnnotatedClass(NodeType.class);
		aMetadataSources.addAnnotatedClass(WayTag.class);
		aMetadataSources.addAnnotatedClass(NodeTag.class);
		aMetadataSources.addAnnotatedClass(WayType.class);
		aMetadataSources.addAnnotatedClass(Key.class);
		aMetadataSources.addAnnotatedClass(KeyNodeType.class);
		aMetadataSources.addAnnotatedClass(KeyWayType.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new BdPersistentManager();
		}
